...
places_import <- read_sf("C:/Datasets/netherlands/gis_osm_places_free_1.shp")
roads_import <- read_sf("C:/Datasets/netherlands/gis_osm_roads_free_1.shp")
water_import <- read_sf("C:/Datasets/netherlands/gis_osm_water_a_free_1.shp")
...
```{r}
radius <- 3000 #radius, in meters, around the center point to map
crs <- 102013 
