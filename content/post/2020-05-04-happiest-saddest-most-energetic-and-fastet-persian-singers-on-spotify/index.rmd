...
[This wonderful visualization](https://github.com/jakelawlor/TidyTuesday_JL/blob/master/CodeFiles/Jan21.20.Spotify.Rmd) inspired me to create a similar plot for some of the most well-known Persian singers and see how their audio features differ from each other.
...
This plot shows the most popular song of each artist and also the least popular track among his top 10 songs. The artists are also sorted based on their average popularity.
